...
debugprob = np.load('numb_sources_300pc_boundary_2e3realization.npy')
...
#fig = ax1.get_figure()
plt.title('point sampling greens functions for 300 pc sources, boundary conditions')
...
plt.savefig('numb_sources_300pc_boundary_2e3realization_point.png',dpi=150)
