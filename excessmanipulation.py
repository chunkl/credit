...
debugprob = np.load('numb_sources_300pc_doubletime_1e5realization.npy')
...
#fig = ax1.get_figure()
plt.title('point sampling greens functions for 300 pc sources, double search time')
...
plt.savefig('numb_sources_300pc_doubletime_1e5realization_point.png',dpi=150)
